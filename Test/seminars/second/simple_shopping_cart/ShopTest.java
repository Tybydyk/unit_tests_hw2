...
//        Cart cart = new Cart(shop);
    ...
    void whenChangingCartCostRecalculationIsCalled() {
        ...
        cart.addProductToCartByID(2); // 250 +
        cart.addProductToCartByID(2); // 250 +
        cart.addProductToCartByID(2); // 250 = 1000
        //assertThat(cart.getTotalPrice()).isEqualTo(870);
        cart.removeProductByID(2); // 1000 - 250 = 750
        // Assert
    ...
    void quantityProductsStoreChanging() {
        ...
        // Act
        cart.addProductToCartByID(4); // 1
        cart.addProductToCartByID(4); // 2
        cart.addProductToCartByID(4); // 3
        cart.addProductToCartByID(4); // 4
        cart.addProductToCartByID(4); // 5
        // Assert
        assertThat(shop.getProductsShop().get(3).getQuantity()).isEqualTo(5); // index = id - 1
    }
...
//        cart = new Cart(shop);
    ...
    void incorrectProductRemoveCausesException() {
        ...
        assertThatThrownBy(() -> cart.removeProductByID(5)).isInstanceOf(RuntimeException.class);
    }
